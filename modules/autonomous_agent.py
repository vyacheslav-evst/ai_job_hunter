...
5. export_report — создать итоговый отчёт
6. get_session_state — проверить текущий прогресс
...
4. Создай итоговый отчёт через export_report
5. Сообщи пользователю результаты: сколько вакансий найдено, проанализировано, 
   топ-3 по релевантности с оценками, путь к отчёту
